...
public class PidController {
    ...
    //**********************************
    /**
     * Create a MiniPID class object. See setP, setI, setD methods for more
     * detailed parameters.
     *
     * @param p Proportional gain. Large if large difference between setpoint
     * and target.
    ...
    /**
     * Create a MiniPID class object. See setP, setI, setD, setF methods for
     ...
     * Some systems can be used with only a P gain, and many can be operated
     * with only PI.<br>
     * For position based controllers, this is the first parameter to tune, with
     * I second. <br>
     ...
     * controller always gets to the control mode. Typically tuned second for
     * "Position" based modes, and third for "Rate" or continuous based modes.
     * <br>
     ...
     * Affects output according to <b>output+=F*Setpoint</b>. Note, that a
     ...
     * much larger range.
     * <br>This limits the reactivity of P term, and restricts impact of large D
     ...
     * filtering, and use only the most recent value. <br>
     * Increasing the filter strength will P and D oscillations, but force
     * larger I values and increase I term overshoot.<br>
