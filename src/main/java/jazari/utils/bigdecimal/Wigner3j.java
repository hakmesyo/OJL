package jazari.utils.bigdecimal;
 ...
 * R. J. Mathar, <a href="http://arxiv.org/abs/1102.5125">Corrigendum to
 * "Universal factorization of ..[J. Phys. A: Math. Gen.37 (2004) 3259]"</a>
 * R. J. Mathar, <a href="http://vixra.org/abs/1202.0093">Symmetries in Wigner
 * 18-j and 21-j Symbols</a>
 *
 * @since 2011-02-15
...
public class Wigner3j {
     ...
     * java -cp . org.nevec.rjm.Wigner3j 3jm 2j1+1 2j2+1 2j3+1 2m1+1 2m2+1
     * 2m3+1<br>
     ...
     *
     * @param args The tag for the type of computation followed by the integer
     * parameters.
     * @since 2011-02-15
     * @author Richard J. Mathar
     */
    ...
    /* wigner3jm */
    /**
     * Wigner 3jn symbol. For the 6j symbol, the input of the 3 lines is "1 2 3
     * 1 5 6", "4 5 3 4 2 6" "2j1+1 2j2+1 2j3+1 2l1+1 2l2+1 2l3+1"
     *
     * @param m1 The information on the number of angular momenta.
     * @param t1 The list of one half of the triads, indexing j, whitespace
     * separated
     * @param t2 The list of the second half of the triads, indexing j,
     * whitespace separated
     * @param j The list of the integer values of the angular momenta. They are
     * actually the doubled j-values plus 1, whitespace separated. Only as many
     * as announced by the m1 parameter are used; trailing numbers are ignored.
     * A. Bar-Shalom and M. Klapisch,
     * <a href="http://dx.doi.org/10.1016/0010-4655(88)90192-0">NJGRAF...</a>,
     ...
     * @param M The list of M-values associated with the J. This contains null
