...
public class Ifactor implements Cloneable, Comparable<Ifactor> {
     ...
     *
     * @param pows the vector with the sorted list of exponents. pows[0] is the
     * exponent of 2, pows[1] the exponent of 3, pows[2] the exponent of 5 etc.
     * Note that this list does not include the primes, but assumes a continuous
     * prime-smooth basis.
     * @author Richard J. Mathar
     */
     ...
     *
     * @param args It takes a single argument n and prints the integer
     * factorizaton.<br>
     * @author Richard J. Mathar
     */
