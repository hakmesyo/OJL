package jazari.machine_learning.classifiers.anten_nd4j_cnn.examples;

import jazari.machine_learning.classifiers.anten_nd4j_cnn.NNParams;
import jazari.machine_learning.classifiers.anten_nd4j_cnn.NeuralNetwork;
import jazari.machine_learning.classifiers.anten_nd4j_cnn.matrix.Matrix;
import jazari.machine_learning.classifiers.anten_nd4j_cnn.matrix.MatrixUtils;
...
public class NNClassificationExample {
    ...
    public static void runKaggleDigitsClassification(boolean useConvolution) throws Exception {
        ...
        Matrix xTrain = dataTrain.copy().getColumns(1, -1);
        Matrix yTrain = dataTrain.copy().getColumns(0, 1);
        Matrix xCV = dataCV.copy().getColumns(1, -1);
        Matrix yCV = dataCV.copy().getColumns(0, 1);
