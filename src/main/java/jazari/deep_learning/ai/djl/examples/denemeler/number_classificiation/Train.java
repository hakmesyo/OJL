 ...
 */
package jazari.deep_learning.ai.djl.examples.denemeler.number_classificiation;
...
//        ImageFolder dataset = initDataset("c:/ai/djl/dataset_pdr/dataset");
        ImageFolder dataset = initDataset("C:\\ai\\djl\\number_dataset");
//        ImageFolder dataset = initDataset("c:/ai/djl/mnist_test");
        ...
        Model model = Models.getModel(Models.NUM_OF_OUTPUT, Models.IMAGE_WIDTH, Models.IMAGE_HEIGHT);
        Trainer trainer = model.newTrainer(config);
        trainer.setMetrics(new Metrics());

        Shape inputShape = new Shape(1, 3, Models.IMAGE_HEIGHT, Models.IMAGE_HEIGHT);
//            Shape inputShape = new Shape(1, 1, Models.IMAGE_WIDTH, Models.IMAGE_HEIGHT);
