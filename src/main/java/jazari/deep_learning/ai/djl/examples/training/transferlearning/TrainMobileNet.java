 ...
 */
public final class TrainMobileNet {

    private static final Logger logger = LoggerFactory.getLogger(TrainMobileNet.class);

    private TrainMobileNet() {
    }
    ...
    public static TrainingResult runExample(String[] args)
        ...
        try (Model model = getModel(nOutput)) {
    ...
    private static Model getModel(int nOutput) throws IOException, ModelNotFoundException, MalformedModelException {
        ...
        newBlock.add(Linear.builder().setUnits(nOutput).build());
