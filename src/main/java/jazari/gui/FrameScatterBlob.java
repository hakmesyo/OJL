 ...
 * @author BAP1
 */
public final class FrameScatterBlob extends javax.swing.JFrame {
     ...
     */
    public FrameScatterBlob() {
        initComponents();
    }

    public FrameScatterBlob(CMatrix cm) {
    ...
    private void initComponents() {
        ...
        panel_blob = new jazari.gui.PanelScatterBlob();
    ...
    private void btn_plotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_plotActionPerformed
        ...
        getScatterBlobPanel().getMatrix().plot(attr);
...
//            String[] s = getScatterPlotPanel().getAxisText();
            getScatterBlobPanel().setMatrix(cmx);
            isSort = false;
...
//            getScatterPlotPanel().setAxisText(s);
    ...
    public PanelScatterBlob getScatterBlobPanel() {
        return (PanelScatterBlob) panel_blob;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrameScatterBlob frm = new FrameScatterBlob(CMatrix.getInstance().randn(2, 130).timesScalar(1));
                frm.setVisible(true);
...
//                frm.getScatterPlotPanel().setAxisText(s);
    ...
    private void savePanel() {
        FactoryUtils.savePanel(getScatterBlobPanel(),txt_dpi.getText());
    }
